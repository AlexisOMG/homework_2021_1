...
QUnit.module('Тестируем функцию sort', function () {
	QUnit.test('Функция делает первую букву слова прописной', function (assert) {
		...
		assert.strictEqual(sort('Rrrrrrrr'), 'Rrrrrrrr'); //ожидаемый результат исправлен с rrrrrrrr на Rrrrrrrr
	});
	...
	QUnit.test('Функция работает правильно', function (assert) {
		...
		assert.strictEqual(sort('космический корабль летит на марс'), 'Абклорь Амрс Ан Еиийккмоссч Еилтт'); // в слове Ан была латинская А вместо русской
